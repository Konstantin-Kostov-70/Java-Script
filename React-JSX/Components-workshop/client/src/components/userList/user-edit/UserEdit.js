...
export const UserEdit = ({
  ...
  const updateUserHandler = (ev) => {
    if (user.address.hasOwnProperty(ev.target.name)) {
      setUpdatedUser(user => ({
        ...user,
  ...
  const submitUpdatedUser = (ev) => {
    ev.preventDefault()
    onUserEdit(updatedUser)
  }
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <div className="input-wrapper">
                  ...
                  name="streetNumber" 
                  type="text" 
                  value={updatedUser.address.streetNumber}
                  onChange={updateUserHandler}
                  />
                </div>
                <p className="form-error">
