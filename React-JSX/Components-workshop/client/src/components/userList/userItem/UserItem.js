    ...
    return (
        ...
        <tr>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={ () => actionClickHandler(user._id, UserAction.Edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => actionClickHandler(user._id, UserAction.Delete)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => actionClickHandler(user._id, UserAction.Details)}>
