...
function solve() {
    ...
    function addInfo(event) {
        ...
        function increaseLikes(ev) {
            ...
            splittedElement = likes.textContent.split(': ');
            let countLikes = Number(splittedElement[1]);
            countLikes++;
            let textInfo = splittedElement[0];
            likes.textContent = textInfo + ': ' + countLikes;
         }
         
        function saveSongs(ev) {
